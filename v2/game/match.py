...
def main():
    ...
    deck1 = deck_loader.load_deck_by_name(deck1_name)
    deck2 = deck_loader.load_deck_by_name(deck2_name)
    ...
    # Create players
    player1 = Player("Player 1", deck1, agent=agent1_class)
    player2 = Player("Player 2", deck2, agent=agent2_class)
